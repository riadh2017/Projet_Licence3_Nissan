...
if(isset($_GET['erreur']))
{
	if($_GET['erreur']=='1')
	{
		echo"<script>alert('bon totalement payer');</script>";
	}
}
if(isset($_GET['message']))
{
  if($_GET['message']=='4')
  {
    ...
    echo"<script>alert('versement superieure au rest a payer');</script>";
  }
...
if(isset($_GET['message']))
{
	if($_GET['message']=='5')
	{
		...
		echo"<script>alert('recu de versement supprimer avec succe');</script>";
	}
}
