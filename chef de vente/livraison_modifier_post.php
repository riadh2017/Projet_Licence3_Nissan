...
echo'  Client       <input type="text" class="client2" name="client"   disabled/> <br><br>
<span>Designation</span><span>couleur</span><span>matricule</span><span>Chassis</span><br>
                    <label for="modele-liv" class="text-eliv"></label>  
                    ...
                    <label for="chassis-li1v" class="text-eliv" > </label><input type="text"  id="chassis" name="chassis" />
                    <input type="hidden" id="id_item" name="id_item"  />
                    <label for="chassis-li1v" class="text-eliv" > </label><input type="text"  id="matricule" name="matricule" />';
