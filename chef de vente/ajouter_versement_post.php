...
echo"<script>alert('versement effectuer avec succe');</script>";
            ...
            $id_command=$_GET['id_command'];
                     ...
                     echo'   <label for="client-recu" class="text-recu">client</label>  <input class="select-client-recu" name="clien"  disabled/>
                             <label for="adresse-recu" class="text-recu">date de recu</label><input type="date" id="adresse-recu" name="date_recue"  required/>
                             <label for="versement-recu" class="text-recu">Versement</label><input type="number" id="versement-recu" name="versement1" value="" required/>
                             <a href="../page/recu_de_versement.php?&id_command='.$id_command.'" id="btn-del-com"><p id="salim">imprimer</p></a>';
                        } 
                        ?> 
