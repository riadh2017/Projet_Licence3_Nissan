...
<div id="container">
 ...
 <p id="title" >Nissan Djurdjura motors</p>	
	...
	if (isset($_GET['message'])) {
		switch ($_GET['message']) {
			case '1':
				echo"<script>alert('le modele de vihecule a éte ajouter avec succes');</script>";
				break;
			
		case '2':
			echo "<script>alert('le modele de vihecule e éte modifier avec succes');</script>";
			break;
			case '3': echo "<script>alert('le modele de vihecule e éte supprimer avec succes ');</script>";
			break;
		}
