...
#msg
{
	...
	<div id="section">
		...
		<div id="right1">
	   		...
	   		<table id="tab_de_resultat">
					...
					) 
				{
                          ...
                          )
					{
		     	    ...
		     	    <form method="POST" action="client-modifier-post.php">
				    <td>'.$donnees['id_client'].'</td>
				    <input type="hidden" name="didi" value="'.$donnees['id_client'].'" id="nomero1"/>
					...
					<td class="numero"> <input type="submit" value="M" id="input_modif" name="Modifier"/></td>
					</form>
					</tr>';
			...
			if ($b==0) {
				echo "<script>alert('aucun resultats trouve')</script>";
