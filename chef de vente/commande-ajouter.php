	   ...
	   <form action="ajouter_command_post.php" method="post">
				 <div id="partie1">
                         <div id="client-commande">
                            ...
                            <label for="nomclient" class="text-commnade">Nom</label><div class="input_container"><ul id="country_list_id"></ul><input type="text" id="nomclient-com" name="nom" onkeyup="autocomplet()" autocomplet="false" required/>
