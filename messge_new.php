...
<body>
  <style type="text/css">body{background: url('commercial/images/back.png') repeat;}
</style>
<div id="container">
	<!-- header -->
    <div id="header">
 ...
 <p id="title" >Nissan Djurdjura motors</p>	
     ...
     <div id="menu">
      ...
      <li><a  href="commercial/proformat.php">f.proformat</a></li>
            <li><a  href="commercial/commande.php">bon de commande </a></li>
            <li><a  href="commercial/livraison.php">bon de livraison</a></li>
            <li><a  href="commercial/versement.php">reçu de versement</a></li>
      <li><a  href="commercial/suiver_des_client.php">suivie des clients</a></li>
      <li><a  href="commercial/mode_de_vente.php">mode de vente</a></li>
      
      <li><a href="commercial/deconnexion.php">deconnexion</a></li>
                      </ul>
        </div> </div>
	<div id="section">  <style type="text/css">#left4{
  margin-top: 6px;
 border-radius:6px;
...
$req=$bdd->query('SELECT * from messagerie where id_destinataire = '. $id_exp.' Limit 0, 10 ');
