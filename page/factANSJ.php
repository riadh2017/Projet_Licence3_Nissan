...
<tr>
  <td class="loc">
    Client:<?php  echo'Au'.$nom; ?><br>
    Adresse:<?php  echo'Au'.$adresse; ?><br>
      Tel:<?php  echo'Au'.$tel; ?>
  </td>
...
<tr>
  <td class="loc1">
    CONDITION DE VENTE:<?php  echo'CNAC/ANSJ'; ?>
  </td>
</tr>
</table> 
...
?>
  ...
  <tr>
    <td colspan="2" class="prix">TVA 17% non icluse</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2" class="prix" >TOTAL ANSJ/CNAC</td>
    <td>&nbsp;<?php echo $total;?></td>
  </tr>
  <tr>
    <td rowspan="5">&nbsp;</td>
  ...
  <tr>
    <td colspan="2" class="prix">NET A PAYER ANSJ/CNAC</td>
    <td>&nbsp;<?php echo '';?></td>
  </tr>
  <tr>
